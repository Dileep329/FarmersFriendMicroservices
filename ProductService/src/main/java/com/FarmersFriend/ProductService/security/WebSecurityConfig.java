package com.FarmersFriend.ProductService.security;
...
import com.FarmersFriend.ProductService.repository.RoleRepository;
import com.FarmersFriend.ProductService.repository.UserRepository;
import com.FarmersFriend.ProductService.security.jwt.AuthEntryPointJwt;
import com.FarmersFriend.ProductService.security.jwt.AuthTokenFilter;
import com.FarmersFriend.ProductService.security.services.UserDetailsServiceImpl;
...
//                                .requestMatchers("/h2-console/**").permitAll()
                                ...
                                .requestMatchers("/product/user/**").hasAnyAuthority("ROLE_USER")
                                .requestMatchers("product/admin/**").hasAnyAuthority("ROLE_ADMIN")
                                .requestMatchers("/seller/**").hasAnyAuthority("ROLE_SELLER")
                                .requestMatchers("/product/seller/**").hasAnyAuthority("ROLE_SELLER")
